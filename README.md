...
|----------|------------|-------|--------|
| 🧠 **Memory Forensics** | 0 | Volatility 3, Rekall | 📝 Coming Soon |
| 🌐 **Network Forensics** | 8 | Wireshark, tcpdump, tshark | ✅ Active |
...
### 🌐 Network Forensics
<details>
<summary>8 cases - Click to expand</summary>
...
- **Total Analyses:** 10 cases
- **Total IOCs:** 70+ indicators
